    ...
    def load_and_split_data(self):
        try:
            ...
            if not os.path.exists(self.train_path):
                error_msg = f"Processed training data not found at {self.train_path}. Please run data preprocessing first (src/data_preprocessing.py)"
                logger.error(error_msg)
                raise FileNotFoundError(error_msg)
            
            if not os.path.exists(self.test_path):
                error_msg = f"Processed test data not found at {self.test_path}. Please run data preprocessing first (src/data_preprocessing.py)"
                logger.error(error_msg)
                raise FileNotFoundError(error_msg)
